...
int main(int argc, char *argv[]) {
  ...
  for (int pow_of_two = 10; pow_of_two <= 27; pow_of_two++) {
    ...
    double accurate_sum =
        (double)ncellsdiv2 * high_value + (double)ncellsdiv2 * low_value;
    ...
    printf("Initializing array (Leblanc problem: high values first, then low "
           "values)\n");
    ...
    printf("  accurate sum %-17.16lg sum %-17.16lg diff %10.4lg relative diff "
           "%10.4lg runtime %lf",
