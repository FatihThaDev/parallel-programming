...
## OpenMP
- The OpenMP version of STREAM can sometimes run on a GPU, but my system has an Intel integrated GPU (6th Gen i3), which is not supported by GCC for GPU offloading on Arch.
