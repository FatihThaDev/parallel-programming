...
## File generator:
- First, I had to generate csv file by running ```bash gcc file_generator.c -o file_generator -lm``` (to prevent linker errors), then running it with `./file_generator` to get the csv.
