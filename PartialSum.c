...
int main(int argc, char *argv[]) {
  ...
  // Process initialization with communicator, getting rank and number of
  // processes
  MPI_Init(&argc, &argv);
  ...
  // You can use the book chapter for this week to help you calculate bounds
  // properly Your code here..
  ...
  // You need to use one of the collective communication calls to provide nsize
  // from all processes to each process and store it in "nsizes" array declared
  // above. Look at MPI_Allgather!
  ...
  printf("Rank %d: processed %d elements, partial sum = %.2f, compute time = "
         "%lf sec\n",
  ...
  // Use reduce collective communication call to get the total sum of all local
  // sums Your code here..
